...
<table>
   ...
   <tr> <td rowspan="3">ASP.NET Core web apps / apis where Authentication was enabled </td> 
      <td>**Supported today**: Configure the code with a new app registration</td>
   </tr>
   <tr> <td>**Working on it**: Configure the code with an existing app registration</td></tr>
   <tr> <td>**Working on it**: Update the app registration based on the code (or troubleshoot)</td></tr>
   <tr> <td>ASP.NET Core web apps / apis where Authentication was not enabled </td><td>**Future work**: Update the code to add authentication</td>
   </tr>
 </table>
